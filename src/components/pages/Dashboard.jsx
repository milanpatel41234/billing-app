  ...
  <div className="container-fluid page-body-wrapper">
    ...
    <div id="right-sidebar" className="settings-panel">
      ...
      <ul className="nav nav-tabs border-top" id="setting-panel" role="tablist">
        <li className="nav-item">
          <Link className="nav-link active" id="todo-tab" data-bs-toggle="tab" to="#todo-section" role="tab" aria-controls="todo-section" aria-expanded="true">TO DO LIST</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" id="chats-tab" data-bs-toggle="tab" to="#chats-section" role="tab" aria-controls="chats-section">CHATS</Link>
        </li>
      </ul>
      ...
      <ul className="nav">
        ...
        <li className="nav-item">
          <Link className="nav-link" data-bs-toggle="collapse" to="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
            <i className="menu-icon mdi mdi-account-multiple-outline" />
          ...
          <div className="collapse" id="ui-basic">
            <ul className="nav flex-column sub-menu">
              ...
              <li className="nav-item"> <Link className="nav-link" to="./dropdowns.html">Dropdowns</Link></li>
              <li className="nav-item"> <Link className="nav-link" to="./typography.html">Typography</Link></li>
            </ul>
          </div>
        </li>
        <li className="nav-item">
          ...
          <div className="collapse" id="form-elements">
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"><Link className="nav-link" to="./basic_elements.html">Basic Elements</Link></li>
            </ul>
          </div>
        </li>
        <li className="nav-item">
          <Link className="nav-link" data-bs-toggle="collapse" to="#charts" aria-expanded="false" aria-controls="charts">
            ...
            <span className="menu-title">Texes</span>
            <i className="menu-arrow" />
          </Link>
          <div className="collapse" id="charts">
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> <Link className="nav-link" to="./chartjs.html">ChartJs</Link></li>
            </ul>
          </div>
        </li>
        <li className="nav-item">
          ...
          <div className="collapse" id="tables">
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> <Link className="nav-link" to="./basic-table.html">Basic table</Link></li>
            </ul>
          </div>
        </li>
        <li className="nav-item">
          ...
          <div className="collapse" id="icons">
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> <Link className="nav-link" to="./mdi.html">Mdi icons</Link></li>
            </ul>
          </div>
        </li>
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="auth">
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> <Link className="nav-link" to="./login.html"> Login </Link></li>
            </ul>
          </div>
        </li>
        <li className="nav-item nav-category">help</li>
        <li className="nav-item">
          <Link className="nav-link" to="http://bootstrapdash.com/demo/star-admin2-free/docs/documentation.html">
    ...
    <div className="main-panel">
            ...
            <div className="home-tab">
              <div className="d-sm-flex align-items-center justify-content-between border-bottom">
                <ul className="nav nav-tabs" role="tablist">
                  <li className="nav-item">
                    <Link className="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" to="#overview" role="tab" aria-controls="overview" aria-selected="true">Overview</Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" id="profile-tab" data-bs-toggle="tab" to="#audiences" role="tab" aria-selected="false">Audiences</Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" id="contact-tab" data-bs-toggle="tab" to="#demographics" role="tab" aria-selected="false">Demographics</Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link border-0" id="more-tab" data-bs-toggle="tab" to="#more" role="tab" aria-selected="false">More</Link>
                  </li>
                </ul>
                <div>
                  <div className="btn-wrapper">
                    <Link to="#" className="btn btn-otline-dark align-items-center"><i className="icon-share" /> Share</Link>
                    <Link to="#" className="btn btn-otline-dark"><i className="icon-printer" /> Print</Link>
                    <Link to="#" className="btn btn-primary text-white me-0"><i className="icon-download" /> Export</Link>
                  </div>
                </div>
              </div>
                                ...
                                <table className="table select-table">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>
                                        <div className="d-flex ">
                                          <img src="images/faces/face1.jpg" alt='iiii'/>
                                          <div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div className="d-flex">
                                          <img src="images/faces/face2.jpg" alt='iiii'/>
                                          <div>
                                            <h6>Laura Brooks</h6>
                                            <p>Head admin</p>
                                          </div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div className="d-flex">
                                          <img src="images/faces/face3.jpg" alt='iiii'/>
                                          <div>
                                            <h6>Wayne Murphy</h6>
                                            <p>Head admin</p>
                                          </div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div className="d-flex">
                                          <img src="images/faces/face4.jpg" alt='face4' />
                                          <div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div className="d-flex">
                                          <img src="images/faces/face5.jpg" alt='iiii'/>
                                          <div>
                          ...
                          <div className="card card-rounded">
                            <div className="card-body card-rounded">
                              ...
                              <div className="list align-items-center pt-3">
                                <div className="wrapper w-100">
                                  <p className="mb-0">
                                    <Link to="#" className="fw-bold text-primary">Show all <i className="mdi mdi-arrow-right ms-2" /></Link>
                                  </p>
                                </div>
                              </div>
                            </div>
                                    ...
                                    <div>
                                      <div className="dropdown">
                                        ...
                                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                          ...
                                          <Link className="dropdown-item" to="#">Year Wise</Link>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
      ...
      <footer className="footer">
        <div className="d-sm-flex justify-content-center justify-content-sm-between">
          <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">Premium <Link to="https://www.bootstrapdash.com/" target="_blank">Bootstrap admin template</Link> from BootstrapDash.</span>
